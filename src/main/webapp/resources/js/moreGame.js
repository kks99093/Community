...
function moreGame(sumId){
	...
	axios.get('/board/moreGame',{
	    ...
	    icon_img.setAttribute('src','http://ddragon.leagueoflegends.com/cdn/10.21.1/img/champion/'+res.data.dDTOList[i].champId+'.png')
	    ...
	    spell_img1.setAttribute('src','http://ddragon.leagueoflegends.com/cdn/10.21.1/img/spell/'+res.data.dDTOList[i].spell1Id +'.png')
	    let spell_img2 = document.createElement('img')
	    spell_img2.setAttribute('src','http://ddragon.leagueoflegends.com/cdn/10.21.1/img/spell/'+res.data.dDTOList[i].spell2Id +'.png')
	    ...
	    item0.setAttribute('src', 'http://ddragon.leagueoflegends.com/cdn/10.21.1/img/item/'+res.data.dDTOList[i].item0+'.png')
	    let item1 = document.createElement('img')
	    item1.setAttribute('onerror','this.src="/res/img/opacity1.png";' )
	    item1.setAttribute('src', 'http://ddragon.leagueoflegends.com/cdn/10.21.1/img/item/'+res.data.dDTOList[i].item1+'.png')
	    let item2 = document.createElement('img')
	    item2.setAttribute('onerror','this.src="/res/img/opacity1.png";' )
	    item2.setAttribute('src', 'http://ddragon.leagueoflegends.com/cdn/10.21.1/img/item/'+res.data.dDTOList[i].item2+'.png')
	    let item6 = document.createElement('img')
	    item6.setAttribute('onerror','this.src="/res/img/opacity1.png";' )
	    item6.setAttribute('src', 'http://ddragon.leagueoflegends.com/cdn/10.21.1/img/item/'+res.data.dDTOList[i].item6+'.png')
	    ...
	    item3.setAttribute('src', 'http://ddragon.leagueoflegends.com/cdn/10.21.1/img/item/'+res.data.dDTOList[i].item3+'.png')
	    let item4 = document.createElement('img')
	    item4.setAttribute('onerror','this.src="/res/img/opacity1.png";' )
	    item4.setAttribute('src', 'http://ddragon.leagueoflegends.com/cdn/10.21.1/img/item/'+res.data.dDTOList[i].item4+'.png')
	    let item5 = document.createElement('img')
	    item5.setAttribute('onerror','this.src="/res/img/opacity1.png";' )
	    item5.setAttribute('src', 'http://ddragon.leagueoflegends.com/cdn/10.21.1/img/item/'+res.data.dDTOList[i].item5+'.png')
	    ...
	    btImg1.setAttribute('src','http://ddragon.leagueoflegends.com/cdn/10.21.1/img/champion/'+res.data.dDTOList[i].blueTeam.champList[0]+'.png')
	    blueTeam.appendChild(btImg1)
	    let btImg2 = document.createElement('img')
	    btImg2.setAttribute('src','http://ddragon.leagueoflegends.com/cdn/10.21.1/img/champion/'+res.data.dDTOList[i].blueTeam.champList[1]+'.png')
	    blueTeam.appendChild(btImg2)
	    let btImg3 = document.createElement('img')
	    btImg3.setAttribute('src','http://ddragon.leagueoflegends.com/cdn/10.21.1/img/champion/'+res.data.dDTOList[i].blueTeam.champList[2]+'.png')
	    blueTeam.appendChild(btImg3)
	    let btImg4 = document.createElement('img')
	    btImg4.setAttribute('src','http://ddragon.leagueoflegends.com/cdn/10.21.1/img/champion/'+res.data.dDTOList[i].blueTeam.champList[3]+'.png')
	    blueTeam.appendChild(btImg4)
	    let btImg5 = document.createElement('img')
	    btImg5.setAttribute('src','http://ddragon.leagueoflegends.com/cdn/10.21.1/img/champion/'+res.data.dDTOList[i].blueTeam.champList[4]+'.png')
	    ...
	    rtImg1.setAttribute('src','http://ddragon.leagueoflegends.com/cdn/10.21.1/img/champion/'+res.data.dDTOList[i].redTeam.champList[0]+'.png')
	    redTeam.appendChild(rtImg1)
	    let rtImg2 = document.createElement('img')
	    rtImg2.setAttribute('src','http://ddragon.leagueoflegends.com/cdn/10.21.1/img/champion/'+res.data.dDTOList[i].redTeam.champList[1]+'.png')
	    redTeam.appendChild(rtImg2)
	    let rtImg3 = document.createElement('img')
	    rtImg3.setAttribute('src','http://ddragon.leagueoflegends.com/cdn/10.21.1/img/champion/'+res.data.dDTOList[i].redTeam.champList[2]+'.png')
	    redTeam.appendChild(rtImg3)
	    let rtImg4 = document.createElement('img')
	    rtImg4.setAttribute('src','http://ddragon.leagueoflegends.com/cdn/10.21.1/img/champion/'+res.data.dDTOList[i].redTeam.champList[3]+'.png')
	    redTeam.appendChild(rtImg4)
	    let rtImg5 = document.createElement('img')
	    rtImg5.setAttribute('src','http://ddragon.leagueoflegends.com/cdn/10.21.1/img/champion/'+res.data.dDTOList[i].redTeam.champList[4]+'.png')
